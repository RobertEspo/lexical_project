...
#visualize map
mapCountryData(auto_familiar_map, nameColumnToPlot="word_camioneta", catMethod = "categorical", missingCountryCol = gray(.8), colourPalette = c("red", "blue"), mapRegion="latin america")
```
---
